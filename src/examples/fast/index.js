...
let Graph = /** @class */ (function(_super) {
  ...
  function Graph(props) {
    ...
    _this.makeItLarge = function() {
      ...
      let generatedSample = generateSample(_this.state.totalNodes);
    ...
    _this.onCopySelected = function() {
      ...
      var x = _this.state.selected.x + 10;
    ...
    _this.onPasteSelected = function() {
      ...
      var newNode = __assign({}, _this.state.copiedNode, { id: Date.now() });
  ...
  Graph.prototype.render = function() {
    ...
    return React.createElement(
      ...
      React.createElement(__1.GraphViewFast, {
        ref: function(el) {
